    ...
    <div className="min-h-screen bg-bg pb-28">
      <div className="mx-auto max-w-2xl px-6 pt-8">
        ...
        <div className="flex flex-col gap-5">
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-text">Nome</label>
            <div className="w-full rounded-full bg-field px-5 py-3 text-sm text-text">
              {func.nome}
            </div>
          </div>
          <div>
          ...
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-text">Telefone</label>
            <div className="w-full rounded-full bg-field px-5 py-3 text-sm text-text">
              {func.telefone}
            </div>
          </div>
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-text">Cargo atual</label>
            <div className="w-full rounded-full bg-field px-5 py-3 text-sm text-text">
              {func.cargo}
            </div>
          </div>
