  ...
  return (
    <div className="min-h-screen bg-bg-base pb-28">
      <div className="px-6 pt-8">
        <h1 className="mb-8 text-center text-2xl font-bold text-texto1">Gestão de Rotas</h1>

        <div className="flex flex-col gap-6 lg:flex-row">
          <div className="flex-1 rounded-3xl bg-componente1 p-6">
            <h2 className="mb-4 text-lg font-bold text-texto2">Mapa de Rotas</h2>
            <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-componente4">
              <img
