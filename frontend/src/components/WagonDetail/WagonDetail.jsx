    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-overlay">
      <div className="mx-4 w-full max-w-md rounded-3xl bg-primary p-6 shadow-xl">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-lg font-bold text-foreground">Detalhes do Vagão {wagon}</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-2xl bg-secondary p-5">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-base font-semibold text-foreground">Status do Vagão</p>
            ...
            <div className="mb-4">
              ...
              <div className="h-3 overflow-hidden rounded-full bg-primary/30">
                <div
            ...
            <div className="flex items-center gap-2">
              <Package size={16} className="text-foreground/70" />
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-foreground">Último registro: Hoje</p>
            </div>
            <div className="flex items-center gap-2">
              <Clock size={16} className="text-foreground/70" />
              <p className="text-sm text-foreground">Atualizado: Agora</p>
            </div>
          </div>
